...
if(isset($_SESSION["lEmail"])){
    ...
    try {
        ...
        $mail->Subject = 'Date has been established';
        $mail->Body = "<div style='background-color: #EDE4FF; padding: 25px; border-radius: 20px;'><h1 style='color: #8c52ff'>Hooray!</h1>
        Dear Renter,<br>
        You are ready to move-in! The landlord has already set your <a href='localhost/RentA/RentersPage/application4Move.php?date=set'>move-in date.</a>
        .<br><br>
        Thank you!
        <br>
