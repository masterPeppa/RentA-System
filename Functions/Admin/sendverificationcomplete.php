...
if(isset($_SESSION["useradmin"])){
    ...
    try {
        ...
        Dear $lName,</h1>
        We are delighted to inform you that your verification process has been successfully 
        completed. Your account is now fully verified and ready for use.
        <br><br>
        Thank you for your cooperation throughout the verification process. If you have 
        any questions or require further assistance, please don't hesitate to contact our 
        support team.
        <br><br>
