...
if(isset($_SESSION["rEmail"])){
    ...
    try {
        ...
        $mail->Subject = 'The applicants are here.';
        $mail->Body = "<div style='background-color: #EDE4FF; padding: 25px; border-radius: 20px;'><h1 style='color: #8c52ff'>Hooray!</h1>
        A potential renter had sent you a rental application, please check and review his/her application to continue the process. <br> <br> Thank you!
        <br>
