...
if(isset($_SESSION['useradmin'])){
    if(isset($_GET['id']) && $_GET['id'] != ""){
        ...
        $selectid = "SELECT * FROM verification_document WHERE user_id='".$_GET['id']."'";
        $executeid = mysqli_query($con, $selectid);
        $row_id = mysqli_fetch_assoc($executeid);

        $imgFront = str_replace("../", "", $row_id['img_front']);
        $imgback = str_replace("../", "", $row_id['img_back']);
        $imgmatch = str_replace("../", "", $row_id['img_match']);
        ...
        if(isset($_GET['notifid']) && $_GET['notifid'] != ""){
            ...
            $update_notif="UPDATE admin_notification SET notif_status='read' WHERE landlord_id = '".$_GET['id']."' AND notif_info='Landlord-Register'";
            $newnotif_update_executed=mysqli_query($con,$update_notif);
        }
?>
<!DOCTYPE html>
    ...
    <section class="home-section">
        ...
        <div class="admin-container p-5">
            ...
            <div class="p-3">
                ...
                <!-- landlord ID -->
                <div class="row w-100">
                    <div class="col-lg-6 col-md-12 mt-5 d-flex flex-column align-items-center">
                        <img src="../<?php echo $imgFront ?>" alt="" class="verification-imgs verification-img">
                        <p class=""> <b> Front ID </b></p>
                    </div>
                    <div class="col-lg-6 col-md-12 mt-5 d-flex flex-column align-items-center ">
                        <img src="../<?php echo $imgback ?>" alt="" class="verification-imgs verification-img">
                        <p class=""><b> Back ID </b></p>
                    </div>
                    <div class="col-12 d-flex flex-column align-items-center mt-5">
                        <img src="../<?php echo $imgmatch ?>" alt="" class=" verification-imgs verification-faceid">
                        <p class=""><b> Face & ID </b></p>
                    </div>
                    <div class="col-12 d-flex gap-3 mt-5 justify-content-between ">
                        <div class="d-flex align-items-center btn-back gap-1">
                            <a onclick="GobackPage()" class="text-secondary"> <i class="bi bi-arrow-left"></i> Back</a>
                        </div>
                        <!-- <div class="d-flex gap-2">
                            <button class="btn admin-btns btn-cancel px-4 py-2" data-bs-toggle="modal" data-bs-target="#rejectModal">Reject</button>
                            <button class="btn admin-btns btn-ok px-4 py-2 text-light">Approve</button>
                        </div> -->
...
<?php
        ...
        echo "<script>window.location.href = 'adminLandlords.php'</script>";
    }
}
else{
