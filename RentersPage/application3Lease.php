    ...
    <!-- PROPERTY INFO SECTION -->
        <section class="section-empty mt-5">
            <div class="d-flex flex-column gap-5 justify-content-center align-items-center">
                <h3 class="mt-5 txt-havent text-center">Your lease agreement had already been processed.</h3>
                <a href="" role="button" class="px-4 py-2 btns-application btn-proceed">Proceed</a>
            </div>
        </section>
