...
if(isset($_SESSION['rEmail'])){
    ...
    $getId = "SELECT * FROM application_data WHERE renter_id='".$getUser['rId']."' AND send_status='rejected' AND agreement='stop'";
    ...
    if(isset($_GET['idnotif']) && $_GET['idnotif'] != ""){
        ...
        $update_notif="UPDATE renter_notification SET notif_status='read' WHERE renter_id = '".$getUser['rId']."' AND notif_info='rejected-application'";
        $newnotif_update_executed=mysqli_query($con,$update_notif);
    }
    ...
    if($rcountidexistence > 0){
        ...
        $lowercasereason = strtolower($rcheckidexistence['rejected_reason']);
    ?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <ul class="d-flex align-items-center ms-auto">
                    ...
                    <div class="dropdown ">
                        ...
                        <ul class="dropdown-menu dropdown-menu-avatar-renter" aria-labelledby="dropdrownbtn-avatar">
                                <li>
                                    <a class="dropdown-item d-flex justify-content-between" href="renterNotifications.php" id="notifCount"> 
                                    </a>
                                </li>
                                <li>
...
<!-- MAIN -->
        ...
        <section class="section-progress d-flex align-items-center justify-content-center">
            ...
            <div class="stepper-wrapper d-flex justify-content-between w-100">
                ...
                <div class="stepper-item d-flex flex-column align-items-center active">
                    ...
                    <div class="step-name active mt-2">Approval</div>
                </div>
    ...
    <!-- PROPERTY INFO SECTION -->
        <section class="section-empty mt-1">
            <div class="d-flex flex-column gap-3 justify-content-center align-items-center">
                <h3 class="mt-5 txt-havent text-center">Sorry! You're application was rejected.</h3>
                <p class="text-center">This is the landlord's reason.</p>
                <p class="landlord-reason p-3"><?php echo ucfirst($lowercasereason); ?></p>
                
                <div class="d-flex justify-content-between gap-3 mt-3">
                    <a href="../messages.php?landlordId=<?php echo $rcheckidexistence['landlord_id'] ?>" role="button" class="btn px-4 py-2 text-decoration-none btns btn-cancel-main text-light">
                        Contact Landlord</a>
                    <a href="../rentals.php" role="button" class="btn px-4 py-2 text-decoration-none btns btn-go text-light">Explore More</a>
                </div>
            </div>
...
<?php
    $updateApplicationdata = "UPDATE application_data SET agreement='finished' WHERE renter_id='".$getUser['rId']."' AND agreement='stop'";
    $executeapplicationdata = mysqli_query($con, $updateApplicationdata);
    }
    else{
        echo "<script>window.location.href = '../../../RentA/RentersPage/application1Empty.php'</script>";
    }
    }
    else{
