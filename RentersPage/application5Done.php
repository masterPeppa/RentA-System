...
<!-- MAIN -->
    ...
    <div class="container-fluid container-submit ">
        ...
        <section class="submit-header px-3 px-md-5 d-flex align-items-center">
    ...
    <!-- PROPERTY INFO SECTION -->
        <section class="section-empty mt-5">
            <div class="d-flex flex-column gap-5 justify-content-center align-items-center">
                ...
                <p class="text-center">Thank you for sharing your feedback! We hope you're in the perfect RentA place.</p>
