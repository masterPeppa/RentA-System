    ...
    <!-- PROPERTY INFO SECTION -->
        <section class="section-empty mt-5">
            <div class="d-flex flex-column gap-5 justify-content-center align-items-center">
                <h3 class="mt-5 txt-havent text-center">Your application is waiting for approval.</h3>
                <p class="text-center">The landlord is already reviewing your rental application. We will notify you when your application is already approved.  </p>
        ...
        setInterval(function(){
            ...
            setInterval(function(){
                $.ajax({
                    ...
                    success: function(data) {
                        if(data == "accepted"){
                            window.location.href = 'application3LeaseWait.php';
                        }
                        else if(data == "rejected"){
                            window.location.href = 'application2Rejected.php';
                        }
