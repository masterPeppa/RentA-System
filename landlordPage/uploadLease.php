<?php
    ...
    $electapplication = "SELECT * FROM application_data WHERE renter_id='$renterId' AND landlord_id='".$lgetId['lID']."' AND property_id ='$propertyid'";
    $executeapplication = mysqli_query($con, $electapplication);
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="input-group pe-md-5 pe-0" id="">
                            ...
                            <input type="text" class="form-control mt-2 input-containers" onkeydown="return /^([0-9]|Backspace)*$/i.test(event.key) || event.key.length > 1" id="startingleasedate" minlength="1" maxlength="10" placeholder="mm/dd/yyyy">
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="input-group pe-md-5 pe-0" id="">
                            <span class="input-group-text mt-2 span-lease-date px-md-3 px-5" id="">Lease end</span>
                            <input type="text" class="form-control mt-2 input-containers" onkeydown="return /^([0-9]|Backspace)*$/i.test(event.key) || event.key.length > 1" id="endleasedate" minlength="1" maxlength="10" placeholder="mm/dd/yyyy">
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex flex-column gap-5">
                    ...
                    <div class="row d-flex align-items-center ">
                        ...
                        <p class="mt-3 mb-4 ps-1 pe-5">
                            Your renter wants to pay the rental payment every <span class="nth-payment"><b><?php echo $getapplicationInfo['preferred_monthly_rent'] ?></b> </span> of the month. 
                        ...
                        <div class="d-flex gap-2 align-items-center ">
                            <p>Every</p>
                            <div class="dropdown advanceMenu preferred-date-menu">
                                <button onblur="blurFunction()" id="preferredDateValue" value="Please select one" class="btn dropdown-toggle preferred-date-data d-flex justify-content-between rental-inputs advance-input btn-advance" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="preferreddatespanvalue">Please select one</span>
                                    <i class="bi bi-chevron-down icons" id="downTypeSm"></i>
                                    <i class="bi bi-chevron-up icons" id="upTypeSm"></i>
                                </button>
                    ...
                    <p class="mt-5 mb-3 lease-type">4. Penalty Agreement </p>
                    <p class="ps-1 pe-5">Check the checkbox if you want to receive penalty amount and please determine how much penalty you like the renter to pay if he/she settled the monthly rent 30 days after the due date?</p>
                    ...
                    <div class="row d-flex align-items-center ">
                        ...
                        <div class="col-md-6 col-12 pe-md-5 pe-0 mt-md-0 mt-3">
                            <div class="input-group penaltyInput" id="penaltyInput">
                                <span class="input-group-text span-peso" id="">₱</span>
                                <input type="text" class="form-control input-containers" onkeydown="return /^([0-9]|Backspace)*$/i.test(event.key) || event.key.length > 1" id="txtpenalty" minlength="1" maxlength="8" placeholder="Enter penalty amount">
                            </div>
                        </div>
                    </div>
                </div>
