...
<head>
    ...
    <link rel="stylesheet" href="../../CSS/stylesVerificationFinished.css">
                ...
                <div class="collapse navbar-collapse" id="navMenuLandlord">
                    ...
                    <ul class="navbar-nav navbar-nav-landlord d-flex align-items-center">
                       ...
                       <li class="nav-item d-block d-sm-block d-md-none">
                        ...
                        <li class="nav-item d-block d-sm-block d-md-none">
                            <a class="nav-link listProperty" onclick="checklistProperty2()">List a Property</a>
                        </li>
                    ...
                    <ul class="d-flex align-items-center ms-auto">
                        ...
                        <div class=" nav-item d-none d-sm-none d-md-block">
                            <a onclick="checklistProperty2()" class="btn btns listProperty btn_listProperty pt-2">List a Property</a>
                        </div>
                    </ul>
...
<!-- MAIN -->
        ...
        <?php
            ...
            ?>
            <header class="main-header"> Verification Finished! </header>
            <p class="mt-3">
                You have successfully submitted all the required files for verification. <br>
                RentA will immediately process and validate your identity.
                For the meantime, you are not allowed to list a property yet.
                We will notify you when you are already verified.
            </p>

            <div class="d-flex align-items-center justify-content-center mt-3">
                <img src="../../imgs/verify.png" alt="" style="width: 175px;" class="img-verify">
            </div>

            <footer class="d-flex flex-row mt-5 justify-content-end">
                <button class="btns proceed-btns" id="btn_finish">Finish</button>
            </footer>
        </div>
