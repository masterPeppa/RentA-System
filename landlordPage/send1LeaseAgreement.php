            ...
            <!-- for save condition -->
                ...
                <div class="dropdown ms-auto d-sm-block d-md-none">
                    ...
                    <ul class="dropdown-menu dropdown-menu-avatar-sm " aria-labelledby="dropdrownbtn-avatar">
                        <li>
                            <a class="dropdown-item dropdown-item-first d-flex justify-content-between" href="landlordNotifications.html" id="smNotifCount">
                                Notifications 
                            </a>
                        </li>
                        <li>
...
<!-- THERE'S APPROVED APPLICANTS -->
    <div class="container-fluid container-approved-applicants px-3 px-md-5 py-3">
        ...
        <p class="mt-5 lease-type">What type of lease agreement would you like to send? </p>

        <div class="div-radio py-3 px-5 mt-3">
            <section class=" mt-3">
                <div class="radio-list">
                    <!-- if eto po ang checked, punta sa send2UploadLease.html -->
                    <div class="radio-item">
                        <input type="radio" name="choice" id="idUpload" value="upload">
                        <label for="idUpload">Upload my own lease.</label>
                    </div>
                    
                    <!--  documents/leaseAgreement.html -->
                    <div class="radio-item">
                        <input type="radio" name="choice" id="idCapture" value="create">
                        <label for="idCapture">Create a lease for me.</label>
                    </div>
                </div>
            </section>
        </div>

        <div class="mt-3 footer-send d-flex justify-content-between align-items-center ">
            <a onclick="GobackPage()" class="return-btns ms-2 d-flex" id=""> <span><i class="bi bi-arrow-left"></i></span>&nbsp;Back</a>
            <a onclick="sendlease()" role="button" class="btn send-continue px-4 py-2 text-light">Continue</a>
        </div>
        <div class="d-none">
