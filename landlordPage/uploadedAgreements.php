...
<!-- MAIN -->
<?php
    $selectUploadLease = "SELECT * FROM lease WHERE renter_id='".$_GET['renter']."' AND property_id='".$_GET['property']."'";
    $executeuploadelease = mysqli_query($con, $selectUploadLease);
    $getUploadLease = mysqli_fetch_assoc($executeuploadelease);

    $imglease = str_replace("../", "", $getUploadLease['img_lease']);
?>

    <div class="container-fluid container-approved-applicants px-3 px-md-5 py-3">
        <div class="d-flex gap-2 align-items-center">
            <a class="" onclick="GobackPage()">
                <h3 class="title title-prev">Leases</h3>
            </a>
            <i class="bi bi-chevron-right back-chev"></i>
            <h3 class="title">Lease Agreement</h3>
        </div>
        
        
        <img src="../<?php echo $imglease ?>" alt="" class="uploaded-lease-view mt-3">
